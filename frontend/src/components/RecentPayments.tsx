  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="rounded-2xl border border-[#E8E8E8] bg-white p-3 sm:p-5 flex flex-col gap-3 sm:gap-4">
        ...
        <div className="grid grid-cols-1 xs:grid-cols-2 gap-2 sm:gap-3 lg:grid-cols-4">
          <select
            value={filters.status}
            onChange={(e) => handleFilterChange("status", e.target.value)}
            className="rounded-xl border border-[#E8E8E8] bg-[#F9F9F9] px-3 py-2.5 text-sm text-[#0A0A0A] focus:border-[#0A0A0A] focus:outline-none transition-all touch-manipulation"
          >
        ...
        {hasActiveFilters && (
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              ...
              className="ml-auto text-[10px] font-bold uppercase tracking-widest text-[#6B6B6B] underline underline-offset-4 hover:text-[#0A0A0A] transition-colors touch-manipulation min-h-[44px] flex items-center"
            >
              Clear all
            </button>
          </div>
      ...
      <div className="flex flex-col xs:flex-row items-start xs:items-center justify-between gap-3 xs:gap-4">
        <p className="text-xs text-[#6B6B6B] font-medium">
          {sortedPayments.length} of {totalCount} payments
          {hasActiveFilters ? " (filtered)" : ""}
        </p>
        <button
          onClick={handleDownloadCSV}
          disabled={!sortedPayments.length}
          className="inline-flex items-center gap-2 rounded-xl border border-[#E8E8E8] bg-white px-3 sm:px-4 py-2 text-[10px] font-bold uppercase tracking-widest text-[#0A0A0A] hover:bg-[#F5F5F5] disabled:opacity-40 transition-all touch-manipulation min-h-[44px]"
        >
          <svg
          ...
          <table className="w-full text-left text-sm min-w-[640px]">
            <thead>
              <tr className="border-b border-[#E8E8E8] bg-[#F9F9F9]">
                ...
                <th className="hidden px-3 sm:px-5 py-3 sm:table-cell">
                  <SortBtn
                ...
                <th className="hidden px-3 sm:px-5 py-3 md:table-cell text-[10px] font-bold uppercase tracking-widest text-[#6B6B6B]">
                  Description
                </th>
                <th className="hidden px-3 sm:px-5 py-3 lg:table-cell">
                  <SortBtn
                ...
                <th className="px-3 sm:px-5 py-3 text-[10px] font-bold uppercase tracking-widest text-[#6B6B6B]">
                  Actions
                </th>
              </tr>
            </thead>
      ...
      {/* Pagination */}
      {totalCount > 0 && (
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4 rounded-2xl border border-[#E8E8E8] bg-white px-3 sm:px-5 py-3">
